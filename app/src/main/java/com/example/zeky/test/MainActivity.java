...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayTratamientos am = new ArrayTratamientos();

        //set new MyAdapter(this, am.getArrayMedicamentos());
        //ListView lw = (ListView) findViewById(R.id.listaTratamientos);
       // lw.setAdapter(new MyAdapter(this, am.getArrayTratamientos()));
    }
